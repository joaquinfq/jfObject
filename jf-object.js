...
module.exports = class jfObject extends Events
{
    ...
    assign(...objs)
    {
        ...
        for (const _obj of objs)
        {
            if (_isObject(_obj))
            {
                for (const _prop of Object.keys(_obj))
                {
                    ...
                    if (typeof _value !== 'function')
                    {
                        if (_isObject(_value))
                        {
                            ...
                            if (_isObject(_current))
                            {
                                ...
                                {
                                    _current = new this.constructor().assign(_current);
                                }
                                _value = _current.assign(_value);
                            }
                        }
                        if (_value !== undefined)
                        {
    ...
    toJSON(filter)
    {
        ...
        const _transform = (property, value) =>
        {
            ...
            if (_type !== 'function' && (property === null || filter(property, value)))
            {
                if (value && _type === 'object')
                {
                    if (value !== this && value instanceof jfObject)
                    {
                        value = value.toJSON(filter);
                    }
